...
const Hero = () => {
  ...
  const bracketLeftY = useTransform(scrollY, [0, 1000], [0, 200]);
  const bracketRightY = useTransform(scrollY, [0, 1000], [0, -200]);
        ...
        <div className="hero-grid">
          ...
          <div className="hero-image">
            ...
            <div className="decorative-brackets">
              <motion.svg style={{ y: bracketLeftY }} version="1.0" xmlns="http://www.w3.org/2000/svg" width="140" height="140" viewBox="0 0 490 499" preserveAspectRatio="xMidYMid meet" className="bracket-left">
              ...
              <motion.svg style={{ y: bracketRightY }} version="1.0" xmlns="http://www.w3.org/2000/svg" width="140" height="140" viewBox="100 100 490 499" preserveAspectRatio="xMidYMid meet" className="bracket-right">
