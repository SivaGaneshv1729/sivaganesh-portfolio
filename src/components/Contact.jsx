      ...
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto bg-slate-900/30 border border-white/5 rounded-[3rem] p-12 md:p-20 text-center backdrop-blur-sm relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6 mb-16">
            <a href="mailto:sivaganeshv1729@gmail.com" className="w-full sm:w-auto px-10 py-5 bg-white text-slate-950 font-bold rounded-2xl hover:bg-orange-500 hover:text-white transition-all transform hover:-translate-y-1 active:scale-95">
              Say Hello
            </a>
            <a href="https://linkedin.com/in/siva-ganesh-vemula/" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-10 py-5 bg-slate-900 border border-slate-800 text-white font-bold rounded-2xl hover:border-orange-500 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center gap-2">
              <LinkedInIcon size={20} /> LinkedIn
            </a>
          </div>
          
          <div className="flex justify-center gap-8">
            <a href="https://github.com/SivaGaneshv1729" target="_blank" rel="noopener noreferrer" className="text-slate-500 hover:text-white transition-colors">
              <GitHubIcon size={24} />
            </a>
            <a href="mailto:sivaganeshv1729@gmail.com" className="text-slate-500 hover:text-white transition-colors">
              <Mail size={24} />
            </a>
          </div>
        </div>
